...
def run_text2img_experiments() -> None:
    model_id = DEFAULT_MODEL_ID
    seed = 42
    prompt = "ultra-realistic product shot of sleek black wireless headphones on a minimalist gray background, studio lighting, sharp focus, professional e-commerce photography"  # TODO: choisissez un prompt e-commerce en anglais unique et gardez-le identique pour tous les runs
    negative = "text, watermark, logo, low quality, blurry, deformed"
...
def run_img2img_experiments() -> None:
    ...
    init_path = "TP2/inputs/my_product.jpg"  # ex: "my_product.jpg"

    prompt = "professional product shot of the same item but made of gold and marble, luxury aesthetic, high-end furniture photography, 8k"   # TODO: prompt e-commerce (en anglais)
    negative = "text, watermark, logo, low quality, blurry, deformed"
